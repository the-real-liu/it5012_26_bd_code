...
class StudentProgressSerializer(serializers.ModelSerializer):
    ...
    def get_avg_score(self, student):
        return student.grade_set.aggregate(Avg("percentage", default=0))[
            "percentage__avg"
        ]

    def get_gpa(self, student):
        percentage = student.grade_set.aggregate(Avg("percentage", default=0))[
            "percentage__avg"
        ]
    ...
    def get_pass_count(self, student):
        return (
            student.grade_set.exclude(percentage__lt=50)
